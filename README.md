...
**Este README es el definitivo.** Los badges ahora son:

- `OSINT-Passive` (en lugar de `OSINT-Pasivo%20%7C%20Analítico` – más limpio).
- `Termux-Compatible` y `Linux-Compatible` con colores estándar.
- Todos los enlaces de badges apuntan a URLs reales (shields.io).

Copia todo el bloque (desde `# 🔥 DIABOLIC ITALIA v6.0` hasta el final) y pégalo en tu `README.md`. Se verá perfecto en GitHub.pip install requests beautifulsoup4 flask
git clone https://github.com/Condor2026/Diabolic_Italia
cd Diabolic_Italia
python Diabolic_Italia.py
