...
Copia todo este texto desde # DIABOLIC ITALIA v6.0 hasta el final, y pégalo en tu archivo README.md. Los enlaces de los badges (shields.io) funcionarán automáticamente si los dejas tal cual.
